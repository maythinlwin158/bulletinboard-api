...
import Bulletinboard.security.ADMIN
import Bulletinboard.security.jwt.JWTConfigurer
...
class SecurityConfiguration(
    ...
    public override fun configure(http: HttpSecurity) {
        http
                ...
                .antMatchers("/posts/excel").authenticated()
                .antMatchers("/post/**").authenticated()
                .antMatchers("/users/**").hasAuthority(ADMIN) // 只有 ADMIN 角色可以看 acutator 的管理 url
